...
"""
Gestor de base de datos SQLite para proyecto_tienda_tech
"""
...
class DatabaseManager:
    ...
    def insertar_usuario(self, usuario):
        ...
        with self.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute('''
                INSERT INTO usuarios (nombre, email, password, fecha_nacimiento, proveedor, rol)
                VALUES (?, ?, ?, ?, ?, ?)
            ''', (
                usuario.nombre,
                usuario.email,
    ...
    def insertar_cliente(self, cliente):
        ...
        with self.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute('''
                INSERT INTO clientes (nombre, email, password, fecha_nacimiento, proveedor)
                VALUES (?, ?, ?, ?, ?)
            ''', (
                cliente.nombre,
                cliente.email,
